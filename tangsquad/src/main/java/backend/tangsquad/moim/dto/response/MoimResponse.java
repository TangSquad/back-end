...
public class MoimResponse {
    ...
    @Builder
    public MoimResponse(Long id, Long userId, String thumbnailurl, Boolean isPublic, String moimName, String moimIntro, String moimDetails, Long currentPeople, Long limitPeople, Long expense, String licenseLimit, List<String> locations, String age, List<String> moods) {
        this.id = id;
        this.userId = userId;
