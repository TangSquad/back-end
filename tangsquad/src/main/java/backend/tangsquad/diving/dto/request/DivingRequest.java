...
public class DivingRequest {
    ...
    @Builder
    public DivingRequest(String divingName, String divingIntro, String thumbnailUrl, Boolean isPublic,String age, List<String> moods, Long limitPeople, String limitLicense, LocalDate startDate, LocalDate endDate, String location) {
